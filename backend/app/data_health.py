...
TABLE_SPECS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "updater": UPDATE_NOTES["daily"],
        "fields": [
            "ts_code", "trade_date", "sniper_score", "sniper_rejected", "sniper_reject_reason",
            "chaos_index_val", "score_chaos", "s_holder_score", "s_chip_vacuum_score",
            "s_ma_state_score", "s_safety_margin_score", "s_macd_weekly_score",
            "s_low_volume_score", "s_golden_pit_score", "s_ignition_score",
            "s_top_list_score", "s_news_score", "s_base_total", "s_dynamic_total",
            "pct_chg", "turnover_rate", "volume_ratio", "trend_reason",
        ],
        "field_updaters": {
            "chaos_index_val": "由日行情振幅、每日换手率和20日净涨跌计算；同 jobs/job_daily_strategy.py",
            "score_chaos": "由 chaos_index_val 映射为 0/5/10/15 分；同 jobs/job_daily_strategy.py",
            "s_holder_score": "兼容字段，当前与 score_chaos 同值",
        },
    },
    {
        "table": "t_weekly_bar",
